    ...
    function Structure(structure) {
      ...
      this.strucstr = ((function() {
        ...
        for (_k = 0, _len2 = _ref7.length; _k < _len2; _k++) {
          b = _ref7[_k];
          _results.push("" + b.source.x + ", " + b.source.y + ", " + b.source.z + " >> " + b.target.x + ", " + b.target.y + ", " + b.target.z + "|" + b.size + "|" + (b.immovable === true));
        }
        return _results;
      }).call(this)).join("\n");
      this.nodestr = ((function() {
        ...
        for (_k = 0, _len2 = _ref7.length; _k < _len2; _k++) {
          n = _ref7[_k];
          _results.push("" + n.x + " " + n.y + " " + n.z + "|" + n.fixed.x + " " + n.fixed.y + " " + n.fixed.z + "|" + n.force.x + " " + n.force.y + " " + n.force.z + "|" + (n.immovable === true));
        }
        return _results;
      }).call(this)).join("\n");
    }
