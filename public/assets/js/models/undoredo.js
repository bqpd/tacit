...
(function() {
  ...
  UndoRedo = (function() {
    ...
    UndoRedo.prototype.log = function() {
      var beam, beamObjs, beams, clock, coordinatesData, data, end, fixedData, forceData, immovable, node, nodeObjs, nodes, size, start, structure, tickfn, _i, _j, _len, _len1, _ref1;
